...
writer.println("<h2>Seller Info</h2>");
...
try{
	...
	st = con.prepareStatement("Select * from item_auction join electronics on item_auction.item_id where item_auction.item_id=electronics.item_id and  item_auction.username=\""+uName+"\"");
